    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        if (!textExceedsMaxLines) {
          return _SelectableReviewText(text: widget.text, style: widget.style);
        }
        return Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _SelectableReviewText(
              text: widget.text,
              style: widget.style,
...
class _SelectableReviewText extends StatefulWidget {
  const _SelectableReviewText({
    required this.text,
    this.style,
    this.maxLines,
    this.visiblePrefix,
  ...
  @override
  State<_SelectableReviewText> createState() => _SelectableReviewTextState();
}

class _SelectableReviewTextState extends State<_SelectableReviewText> {
  ...
  @override
  void didUpdateWidget(_SelectableReviewText oldWidget) {
    super.didUpdateWidget(oldWidget);
